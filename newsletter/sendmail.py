...
def fetch_git_content(repository_url):
    ...
    content = latest_commit.tree.blobs[0].data.decode('utf-8')
...
def generate_newsletter_content(content):
    ...
    templates_dir = '/templates'  # Update with your templates directory
...
# Example usage
repository_url = 'https://github.com/SJ-Kumar/SJ-Kumar.git'  # Update with your Git repository URL
content = fetch_git_content(repository_url)
newsletter_content = generate_newsletter_content(content)
recipients = ['employee1@example.com', 'employee2@example.com']  # Update with selective recipients
